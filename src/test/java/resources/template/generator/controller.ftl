...
public class ${modelNameUpperCamel}Controller {
    ...
    @PostMapping("/insert")
    public RetResult<Integer> insert(@RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}) throws Exception{
    ...
    @PostMapping("/update")
    public RetResult<Integer> update(@RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}) throws Exception {
