...
import com.example.user.core.constant.ProjectConstant;
...
public class CodeGenerator {
    ...
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://10.16.33.51:3306/df_oa?serverTimezone=UTC";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "Middle2020";
    ...
    // @author
    private static final String AUTHOR = "df";
    // @date
